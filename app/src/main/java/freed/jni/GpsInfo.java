...
public class GpsInfo {
    ...
    private native void setGpsInfo(double Altitude,
                                   float[] Latitude,
                                   float[] Longitude,
                                   String Provider,
                                   float[] gpsTime,
    ...
    public GpsInfo(Location location) {
        byteBuffer = init();
        setGpsInfo(location.getAltitude(),
                   parseGpsvalue(location.getLatitude()),
                   parseGpsvalue(location.getLongitude()),
                   location.getProvider(),
                   parseGPStime(location.getTime()),
                   parseGPSdate(location.getTime()),
                   byteBuffer);
    }
