...
public class DngProfile {
    ...
    private DngProfile(int blacklevel,
                       int whitelevel,
                       int widht,
                       int height,
                       int rawType,
    ...
    public DngProfile(int blacklevel,
                      int whitelevel,
                      int widht,
                      int height,
                      int rawType,
    ...
    public static DngProfile getProfile(int blacklevel,
                                        ...
                                        double[] noise,
                                        String name) {
        return new DngProfile(blacklevel,
                              whitelevel,
                              widht,
                              height,
                              rawFormat,
                              bayerPattern,
                              0,
                              new CustomMatrix(matrix1, matrix2, neutral, fmatrix1, fmatrix2, rmatrix1, rmatrix2, noise),
                              name);
    }
    ...
    private native void setDngInfo(ByteBuffer javaHandler,
                                   int blacklevel,
                                   int whitelevel,
                                   int widht,
                                   int height,
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (byteBuffer != null) { clear(byteBuffer); }
    }
}
