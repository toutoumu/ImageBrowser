...
public class CustomMatrix {
    ...
    private native void setMatrixes(ByteBuffer buffer,
                                    float[] colorMatrix1,
                                    float[] colorMatrix2,
                                    float[] neutral,
                                    float[] fMatrix1,
    ...
    public CustomMatrix(float[] matrix1,
                        float[] matrix2,
                        float[] neutral,
                        float[] fmatrix1,
                        float[] fmatrix2,
    ...
    public CustomMatrix(String matrix1,
                        String matrix2,
                        String neutral,
                        String fmatrix1,
                        String fmatrix2,
    ...
    public static float[] getMatrixFromString(String m) {
        if (m.equals("NULL") || TextUtils.isEmpty(m)) { return null; }
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            } else { ar[i] = Float.parseFloat(split[i]); }
        }
        return ar;
    }
    ...
    public static double[] getDoubleMatrixFromString(String m) {
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            } else { ar[i] = Double.parseDouble(split[i]); }
        }
        return ar;
    }
