...
public class SettingKeys {
    ...
    public final static Key<SettingMode> TNR_V = new Key(SettingMode.class, R.string.aps_tnr_v);
    ...
    public final static Key<SettingMode> SeeMore = new Key(SettingMode.class, R.string.aps_seemore);
    // advanced wb correction?
    ...
    public final static Key<SettingMode> DigitalImageStabilization =
        new Key(SettingMode.class, R.string.aps_digitalimagestabmode);
    public final static Key<SettingMode> VideoStabilization = new Key(SettingMode.class, R.string.aps_videoStabilisation);
    public final static Key<SettingMode> MemoryColorEnhancement =
        new Key(SettingMode.class, R.string.aps_memorycolorenhancementmode);

    public final static Key<SettingMode> NonZslManualMode = new Key(SettingMode.class, R.string.aps_nonzslmanualmode);
    //used on htc devices to enable q3a on raw capture
    ...
    public final static Key<SettingMode> dualPrimaryCameraMode =
        new Key(SettingMode.class, R.string.aps_dualprimarycameramode);
    ...
    public final static Key<SettingMode> COLOR_CORRECTION_MODE =
        new Key(SettingMode.class, R.string.aps_colorcorrectionmode);
    ...
    public final static Key<SettingMode> RAW_PICTURE_FORMAT_SETTING =
        new Key(SettingMode.class, R.string.aps_rawpictureformat);
    ...
    public final static Key<GlobalBooleanSettingMode> needRestartAfterCapture =
        new Key(GlobalBooleanSettingMode.class, R.string.aps_needrestartaftercapture);
    public final static Key<GlobalBooleanSettingMode> forceRawToDng =
        new Key(GlobalBooleanSettingMode.class, R.string.aps_forcerawtondng);

    public final static Key<ApiBooleanSettingMode> useQcomFocus =
        new Key(ApiBooleanSettingMode.class, R.string.aps_qcomfocus);
    public final static Key<ApiBooleanSettingMode> support12bitRaw =
        new Key(ApiBooleanSettingMode.class, R.string.aps_support12bitraw);
    public final static Key<SettingMode> orientationHack = new Key(SettingMode.class, R.string.aps_orientationHack);
    public final static Key<ApiBooleanSettingMode> openCamera1Legacy =
        new Key(ApiBooleanSettingMode.class, R.string.aps_opencamera1legacy);
    public final static Key<ApiBooleanSettingMode> useHuaweiWhiteBalance =
        new Key(ApiBooleanSettingMode.class, R.string.aps_usehuawei_wb);
    public final static Key<ApiBooleanSettingMode> SWITCH_ASPECT_RATIO =
        new Key(ApiBooleanSettingMode.class, R.string.aps_switch_aspect_ratio);
    public final static Key<ApiBooleanSettingMode> XIAOMI_VIDEO_RECORD_CONTROL =
        new Key(ApiBooleanSettingMode.class, R.string.aps_xiaomi_video_record_control);
    public final static Key<ApiBooleanSettingMode> XIAOMI_PRO_VIDEO_LOG =
        new Key(ApiBooleanSettingMode.class, R.string.aps_xiaomi_pro_video_log);
    public final static Key<ApiBooleanSettingMode> QCOM_VIDEO_HDR10 =
        new Key(ApiBooleanSettingMode.class, R.string.aps_qcom_video_hdr);

    public final static Key<ApiBooleanSettingMode> ZOOM_ON_MANUALFOCUS =
        new Key(ApiBooleanSettingMode.class, R.string.aps_zoom_on_mf);
    public final static Key<SettingMode> ZOOM_ON_MANUALFOCUS_ZOOMFACTOR =
        new Key(SettingMode.class, R.string.aps_zoom_on_mf_zoomfactor);
    public final static Key<SettingMode> ZOOM_ON_MANUALFOCUS_ZOOMDURATION =
        new Key(SettingMode.class, R.string.aps_zoom_on_mf_zoomduration);
    public final static Key<ApiBooleanSettingMode> HISTOGRAM_STATS_QCOM =
        new Key(ApiBooleanSettingMode.class, R.string.aps_histogram_stats_qcom);

    public final static Key<GlobalBooleanSettingMode> useCustomMatrixOnCamera2 =
        new Key(GlobalBooleanSettingMode.class, R.string.aps_usecustom_matrix_oncamera2);

    public final static Key<ApiBooleanSettingMode> ENABLE_VIDEO_OPMODE =
        new Key(ApiBooleanSettingMode.class, R.string.aps_enable_video_opmode);
    ...
    public final static GlobalKey<GlobalBooleanSettingMode> CHECKFORUPDATES =
        new GlobalKey<>(GlobalBooleanSettingMode.class, R.string.aps_checkforupdates);
    public final static GlobalKey<GlobalBooleanSettingMode> SHOWMANUALSETTINGS =
        new GlobalKey<>(GlobalBooleanSettingMode.class, R.string.aps_showmanualsettings);
    public final static GlobalKey<SettingMode> PREVIEW_POST_PROCESSING_MODE =
        new GlobalKey<>(SettingMode.class, R.string.aps_preview_post_processing_mode);
    public final static GlobalKey<GlobalBooleanSettingMode> NightOverlay =
        new GlobalKey<>(GlobalBooleanSettingMode.class, R.string.aps_nightoverlay);
    public final static GlobalKey<SettingMode> LOCATION_MODE = new GlobalKey(SettingMode.class, R.string.aps_location);
    public final static GlobalKey<GlobalBooleanSettingMode> TouchToCapture =
        new GlobalKey(GlobalBooleanSettingMode.class, R.string.aps_touchtocapture);
    ...
    public final static GlobalKey<SettingMode> FOCUSPEAK_COLOR =
        new GlobalKey(SettingMode.class, R.string.aps_focuspeakcolor);
    public final static GlobalKey<SettingMode> EXTERNAL_SHUTTER =
        new GlobalKey(SettingMode.class, R.string.aps_externalshutter);
