...
public class ImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imageframentBinding =
            DataBindingUtil.inflate(inflater, layout.freedviewer_screenslide_imageframent, container, false);
    ...
    public synchronized void onDestroyView() {
        super.onDestroyView();
        if (imageFragmentModel != null) { imageFragmentModel.setHistodata(null); }
    }

    private final OnClickListener onImageClick = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if (onClickListener != null) { onClickListener.onFragmentClick(ImageFragment.this); }
        }
    };
}
