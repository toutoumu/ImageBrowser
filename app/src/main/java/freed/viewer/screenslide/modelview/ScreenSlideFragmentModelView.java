...
public class ScreenSlideFragmentModelView extends ViewModel {
    ...
    private final ScreenSlideFragment.FragmentClickClistner fragmentclickListner =
        new ScreenSlideFragment.FragmentClickClistner() {
            @Override
            public void onFragmentClick(Fragment v) {
                if (!topBar.getVisibility()) {
                    ...
                    if (infoButtonModel.getShowExifInfo()) { exifViewModel.setVisibility(true); }
                } else {
    ...
    public void updateUi(BaseHolder file) {
        ...
        if (file != null && file.getName() != null) {
            ...
            if (file.getName().toLowerCase().endsWith(StringUtils.FileEnding.JPG) || file.getName()
                .toLowerCase()
                .endsWith(StringUtils.FileEnding.JPS)) {
                processExif(file);
                if (infoButtonModel.getShowExifInfo()) { exifViewModel.setVisibility(true); }
            ...
            if (file.getName().toLowerCase().endsWith(StringUtils.FileEnding.RAW) || file.getName()
                .toLowerCase()
