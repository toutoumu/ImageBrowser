...
public class ExifLoader extends ImageTask {
    ...
    public boolean process() {
        ...
        try {
            ...
            if (file instanceof FileHolder && file.exists()) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N && file.exists()) {
                    InputStream pfd = FreedApplication.getContext()
                        .getContentResolver()
                        .openInputStream(((UriHolder) file).getMediaStoreUri());
        ...
        try {
            ...
            if (expostring == null) { exifViewModel.getShutter().setText(""); } else {
        ...
        try {
            ...
            if (fnums != null) { exifViewModel.getFnumber().setText("\ue003" + fnums); } else {
        ...
        try {
            ...
            if (isos != null) { exifViewModel.getIso().setText("\uE002" + isos); } else {
