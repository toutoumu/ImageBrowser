...
public class GridViewFragment extends Fragment implements I_OnActivityResultCallback {
    ...
    private void bindGridModelView() {
        if (gridviewfragmentBinding == null || gridViewFragmentModelView == null) { return; }
        ...
        gridViewFragmentModelView.getFinishActivityModel()
        ...
        gridViewFragmentModelView.getAlterDialogModel()
            .addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
                @Override
                public void onPropertyChanged(Observable sender, int propertyId) {
        ...
        gridViewFragmentModelView.getIntentSenderModel()
            .addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
                @Override
                public void onPropertyChanged(Observable sender, int propertyId) {
                    try {
                        startIntentSenderForResult(gridViewFragmentModelView.getIntentSenderModel().getIntentSender(),
    ...
    public void onResume() {
        ...
        if (gridViewFragmentModelView.getFilesHolderModel().getFiles() != null) {
            gridViewFragmentModelView.getFilesHolderModel()
                .setFiles(gridViewFragmentModelView.getFilesHolderModel().getFiles());
        }
    }
    ...
    private void firstload() {
        if (mPagerAdapter == null) {
            ...
            gridViewFragmentModelView.getViewStateModel()
                .addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
                    @Override
                    public void onPropertyChanged(Observable sender, int propertyId) {
                ...
                .addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
                    ...
                    public void onPropertyChanged(Observable sender, int propertyId) {
                        if (propertyId == BR.files) {
                            getActivity().runOnUiThread(() -> mPagerAdapter.setGridImageViewModels(gridViewFragmentModelView.getFilesHolderModel()
                                                                                                       .getGridImageViewModels()));
                        }
                    }
                });
