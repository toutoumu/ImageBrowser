...
public class ButtonOptionsModel extends VisibilityModel implements Popup, View.OnClickListener {
    ...
    public ButtonOptionsModel(View.OnClickListener onDeleteButtonListner,
                              ...
                              View.OnClickListener onRawStackButtonListner,
                              GridViewFragmentModelView gridViewFragmentModelView) {
        clickListeners = new View.OnClickListener[] {
            onDeleteButtonListner, onJpgStackButtonListner, onRawToDngButtonListner, onRawStackButtonListner
        };
    ...
    private final View.OnClickListener onClickListener = v -> {
        ...
        for (int i = 0; i < getValues().length; i++) {
            if (txt.equals(getValues()[i])) { getClickListeners()[i].onClick(v); }
        }
    };
    ...
    public void onClick(View v) {
        ...
        } else { gridViewFragmentModelView.getPopupMenuModel().setVisibility(false); }
    }
}
