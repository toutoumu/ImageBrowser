...
public class ImageAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        if (gridImageViewModels != null) { return gridImageViewModels.size(); }
        return 0;
    }
    ...
    public View getView(int position, View convertView, ViewGroup container) {
        ...
        if (gridImageViewModels.size() <= position) { position = gridImageViewModels.size() - 1; }
    ...
    public void SetViewState(ViewStates states) {
        ...
        if (gridImageViewModels == null) { return; }
