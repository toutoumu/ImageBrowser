...
public class ActivityFreeDviewer extends ActivityAbstract {
                ...
                public void onPropertyChanged(Observable sender, int propertyId) {
                    if (BR.formatType == propertyId) {
                        screenSlideFragmentModelView.getFilesHolderModel()
                            .setFormatTypes(gridViewFragmentModelView.getFilesHolderModel().getFormatType());
                    }
                }
            });
    ...
    private void loadGridView(int position, View view) {
        ...
        if (griditem == null) { griditem = gridViewFragment.GetGridItem(0); }
        ...
        // properties (X, Y).
        if (griditem != null) { griditem.getGlobalVisibleRect(startBounds); }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == gridViewFragment.STACK_REQUEST || requestCode == gridViewFragment.DNGCONVERT_REQUEST) {
            ...
            } else { fileListController.loadDefaultFiles(); }
        }
