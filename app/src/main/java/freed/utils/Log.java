...
public class Log {
    ...
    public static void destroy() {
        if (fileLog != null) { fileLog.destroy(); }
        fileLog = null;
    }

    public static void flush() {
        if (fileLog != null) { fileLog.flush(); }
    }
    ...
    public static void v(String TAG, String msg) {
        if (fileLog != null && msg != null) {
            fileLog.writeString("V:"
                                    + DateFormat.format("hh.mm.ss", Calendar.getInstance().getTime())
                                    + ":"
                                    + TAG
                                    + ":"
                                    + msg);
    ...
    public static void WriteEx(Throwable ex) {
        ...
        if (fileLog != null) { fileLog.writeString(errors.toString()); }
        ex.printStackTrace();
    }
