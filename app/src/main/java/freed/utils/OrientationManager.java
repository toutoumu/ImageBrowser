...
public class OrientationManager {
    ...
    private int calcCurrentOrientation(int orientation) {
        ...
        if (orientation >= 315 || orientation < 45) { orientationToRet = 90; } else if (orientation < 135
            && orientation > 45) { orientationToRet = 180; } else if (orientation >= 135
            && orientation < 230) { orientationToRet = 270; }
