...
public class MediaScannerManager {
    ...
    public static void ScanMedia(Context context, BaseHolder file) {
        ...
        } else if (file instanceof UriHolder) { intent.setData(((UriHolder) file).getMediaStoreUri()); }
    ...
    public static void ScanMedia(Context context, BaseHolder[] fileHolders) {
        if (fileHolders == null || fileHolders.length == 0 || fileHolders[0] instanceof UriHolder) { return; }
