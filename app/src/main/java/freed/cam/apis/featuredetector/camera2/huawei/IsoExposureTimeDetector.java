...
public class IsoExposureTimeDetector extends BaseParameter2Detector {
    ...
    protected void findAndFillSettings(CameraCharacteristics characteristics) {
        if (Objects.equals(characteristics.get(CameraCharacteristicsHuawei.HUAWEI_PROFESSIONAL_MODE_SUPPORTED),
                           Byte.valueOf((byte) 1))) {
            ...
            if (maxiso > 0) { max = SettingsManager.getInstance().getCamera2MaxIso(); }
