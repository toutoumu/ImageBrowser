...
public class SupportedVideoProfilesDetector {
    ...
    public HashMap<String, VideoMediaProfile> getDefaultVideoMediaProfiles(int camera_id) {
        ...
        checkIfProfileSupported(camera_id,
                                CamcorderProfile.QUALITY_480P,
                                "480p",
                                true,
                                VideoMediaProfile.VideoMode.Normal,
                                supportedProfiles);
        checkIfProfileSupported(camera_id,
        ...
        checkIfProfileSupported(camera_id,
                                ...
                                "Timelapse480p",
                                false,
                                VideoMediaProfile.VideoMode.Timelapse,
                                supportedProfiles);
        checkIfProfileSupported(camera_id,
        ...
        checkIfProfileSupported(camera_id,
                                ...
                                supportedProfiles);
        checkIfProfileSupported(camera_id,
                                CAMCORDER_QUALITY_TIME_LAPSE_2160pDCI,
                                "Timelapse2160pDCI",
                                false,
                                VideoMediaProfile.VideoMode.Timelapse,
                                supportedProfiles);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            checkIfProfileSupported(camera_id,
                                    ...
                                    "1080pHFR",
                                    true,
                                    VideoMediaProfile.VideoMode.Highspeed,
                                    supportedProfiles);
            checkIfProfileSupported(camera_id,
    ...
    private void checkIfProfileSupported(int camera_id,
                                         int camcorderProfile,
                                         String name,
                                         boolean isAudioAcitve,
                                         VideoMediaProfile.VideoMode videoMode,
                                         HashMap<String, VideoMediaProfile> supportedProfiles) {
        try {
            if (CamcorderProfile.hasProfile(camera_id, camcorderProfile)) {
                supportedProfiles.put(name,
                                      new VideoMediaProfile(CamcorderProfile.get(camera_id, camcorderProfile),
                                                            name,
                                                            videoMode,
                                                            isAudioAcitve));
    ...
    public HashMap<String, VideoMediaProfile> getLGVideoMediaProfiles(int camera_id) {
        ...
        checkIfLGProfileSupported(camera_id,
                                  CamcorderProfileExRef.QUALITY_480P,
                                  "480p",
                                  true,
                                  VideoMediaProfile.VideoMode.Normal,
                                  supportedProfiles);
        checkIfLGProfileSupported(camera_id,
                                  CamcorderProfileExRef.QUALITY_720P,
                                  "720p",
                                  true,
                                  VideoMediaProfile.VideoMode.Normal,
                                  supportedProfiles);
        checkIfLGProfileSupported(camera_id,
                                  CamcorderProfileExRef.QUALITY_1080P,
                                  "1080p",
                                  true,
                                  VideoMediaProfile.VideoMode.Normal,
                                  supportedProfiles);
        ...
        checkIfLGProfileSupported(camera_id,
                                  ...
                                  supportedProfiles);
        checkIfLGProfileSupported(camera_id,
                                  CamcorderProfileExRef.QUALITY_TIME_LAPSE_480P,
                                  "Timelapse480p",
                                  false,
                                  VideoMediaProfile.VideoMode.Timelapse,
                                  supportedProfiles);
        checkIfLGProfileSupported(camera_id,
                                  CamcorderProfileExRef.QUALITY_TIME_LAPSE_720P,
                                  "Timelapse720p",
                                  false,
                                  VideoMediaProfile.VideoMode.Timelapse,
                                  supportedProfiles);
        checkIfLGProfileSupported(camera_id,
                                  CamcorderProfileExRef.QUALITY_TIME_LAPSE_1080P,
                                  "Timelapse1080p",
                                  false,
                                  VideoMediaProfile.VideoMode.Timelapse,
                                  supportedProfiles);
    ...
    private void checkIfLGProfileSupported(int camera_id,
                                           int camcorderProfile,
                                           String name,
                                           boolean isAudioAcitve,
                                           VideoMediaProfile.VideoMode videoMode,
