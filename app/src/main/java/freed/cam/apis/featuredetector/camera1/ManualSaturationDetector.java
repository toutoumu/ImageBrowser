    ...
    private void detectManualSaturation(Camera.Parameters parameters) {
        if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK) {
            try {
                ...
                if (parameters.get(camstring(R.string.saturation)) != null
                    && parameters.get(camstring(R.string.saturation_values)) != null) {
                    SettingsManager.get(SettingKeys.M_Saturation)
                        .setValues(parameters.get(camstring(R.string.saturation_values)).split(","));
            ...
            try {
                ...
                if (parameters.get(FreedApplication.getStringFromRessources(R.string.lg_color_adjust_max)) != null
                    ...
                    min =
                        Integer.parseInt(parameters.get(FreedApplication.getStringFromRessources(R.string.lg_color_adjust_min)));
                    max =
                        Integer.parseInt(parameters.get(FreedApplication.getStringFromRessources(R.string.lg_color_adjust_max)));
                    SettingsManager.get(SettingKeys.M_Saturation)
                        .setCamera1ParameterKEY(FreedApplication.getStringFromRessources(R.string.lg_color_adjust));
                    ...
                    && parameters.get(camstring(R.string.min_saturation)) != null) {
                    Log.d(TAG, "Saturation: Default");
