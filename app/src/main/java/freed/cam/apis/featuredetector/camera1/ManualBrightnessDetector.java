    ...
    private void detectManualBrightness(Camera.Parameters parameters) {
        if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK) {
            ...
            if (parameters.get(camstring(R.string.brightness)) != null
                && parameters.get(camstring(R.string.brightness_values)) != null) {
                SettingsManager.get(SettingKeys.M_Brightness)
                    .setValues(parameters.get(camstring(R.string.brightness_values)).split(","));
            ...
            try {
                ...
                if (parameters.get(camstring(R.string.brightness_max)) != null
                    && parameters.get(camstring(R.string.brightness_min)) != null) {
                    ...
                    && parameters.get(camstring(R.string.min_brightness)) != null) {
                ...
                if (max > 0) {
                    if (parameters.get(camstring(R.string.brightness)) != null) {
                        ...
                        SettingsManager.get(SettingKeys.M_Brightness)
                            .setCamera1ParameterKEY(camstring(R.string.luma_adaptation));
                    }
                    SettingsManager.get(SettingKeys.M_Brightness).setValues(createStringArray(min, max, 1));
                    SettingsManager.get(SettingKeys.M_Brightness)
                        .set(parameters.get(SettingsManager.get(SettingKeys.M_Brightness).getCamera1ParameterKEY()));
                    SettingsManager.get(SettingKeys.M_Brightness).setIsSupported(true);
                }
