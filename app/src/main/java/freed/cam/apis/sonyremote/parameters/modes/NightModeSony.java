...
public class NightModeSony extends BaseModeParameterSony {
    ...
    public NightModeSony(PreviewStreamDrawer simpleStreamSurfaceView) {
        ...
        if (RenderScriptManager.isSupported()) { setViewState(ViewState.Visible); }
    }
    ...
    public void SetValue(String valueToSet, boolean setToCamera) {
        ...
        } else { simpleStreamSurfaceView.nightmode = PreviewStreamDrawer.NightPreviewModes.off; }
    }
    ...
    public String[] getStringValues() {
        return new String[] {
            ...
            GRAYSCALE, EXPOSURE /*, ZOOMPREVIEW*/
        };
    }
