...
public class JsonUtils {
    ...
    public static boolean findBooleanInformation(JSONObject replyJson, int indexpos, String typeS, String subtype)
    ...
    public static String findStringInformation(JSONObject replyJson, int indexpos, String typeS, String subtype)
        throws JSONException {
        String value = "";
    ...
    public static String[] findStringArrayInformation(JSONObject replyJson, int indexpos, String typeS, String subtype)
        throws JSONException {
