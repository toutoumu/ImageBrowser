...
public class FocusHandler extends AbstractFocusHandler implements FocusEvents, I_SonyApi {
    ...
    public void StartTouchToFocus(int x, int y, int width, int height) {
        ...
        if (this.cameraUiWrapper.getParameterHandler() == null) { return; }
        if (this.isFocusing) {
        ...
        if (this.focusEvent != null) { this.focusEvent.FocusStarted(x, y); }
    }
    ...
    public void SonyApiChanged(Set<String> mAvailableCameraApiSet) {
        ...
        if (mAvailableCameraApiSet.contains("setTouchAFPosition")) { focusEvent.TouchToFocusSupported(true); } else {
