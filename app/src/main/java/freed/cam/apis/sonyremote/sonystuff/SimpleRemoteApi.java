...
public class SimpleRemoteApi {
    ...
    public JSONObject actEnableMethods(String methods, String devname, String devid, String sg) throws IOException {
        try {
            String req = "{\"method\":\"actEnableMethods\",\"params\":[{\"developerName\":\""
                + devname
                + "\",\"developerID\":\""
                + devid
                + "\",\"sg\":\""
    ...
    public JSONObject actObjectTracking(double x, double y) throws IOException {
        try {
            return executeSetMethod(CAMERA,
                                    "actTrackingFocus",
                                    new JSONArray().put(new JSONObject().put("xPosition", x).put("yPosition", y)));
        } catch (JSONException e) {
            throw new IOException(e);
        }
    }
    ...
    public void setLiveviewFrameInfo(boolean enable) throws IOException {
        String service = "camera";
        try {
            executeSetMethod(service,
                             "setLiveviewFrameInfo",
                             new JSONArray().put(new JSONObject().put("frameInfo", enable)));
        } catch (JSONException e) {
            throw new IOException(e);
        }
    }
