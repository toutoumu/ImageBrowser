...
public class BaseCCTManual extends BaseManualParameter {
    ...
    public BaseCCTManual(final Parameters parameters,
                         final CameraWrapperInterface cameraUiWrapper,
        ...
        } else { key_value = SettingsManager.get(SettingKeys.M_Whitebalance).getCamera1ParameterKEY(); }
    }
    ...
    protected void set_manual() {
        ...
        try {
            if (parameters.get("whitebalance-values").contains("manual") && parameters.get("manual-wb-modes")
