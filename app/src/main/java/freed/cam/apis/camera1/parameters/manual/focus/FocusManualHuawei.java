...
public class FocusManualHuawei extends BaseFocusManual {
    ...
    public void setValue(int valueToSet, boolean setToCamera) {
        ...
        if (valueToSet == 0) {
            parameters.set(FreedApplication.getStringFromRessources(R.string.hw_hwcamera_flag),
                           FreedApplication.getStringFromRessources(R.string.on_));
            parameters.set(FreedApplication.getStringFromRessources(R.string.hw_manual_focus_mode),
