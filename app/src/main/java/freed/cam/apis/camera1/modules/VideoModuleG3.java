...
public class VideoModuleG3 extends AbstractVideoModule {
    ...
    protected void initRecorder() {
        ...
        if (SettingsManager.getGlobal(SettingKeys.LOCATION_MODE)
            ...
            if (location != null) { recorder.setLocation(location); }
        }
    ...
    private void loadProfileSpecificParameters() {
        ...
        if (((ParametersHandler) cameraUiWrapper.getParameterHandler()).getParameters().get("preview-fps-range") != null) {
            ((ParametersHandler) cameraUiWrapper.getParameterHandler()).getParameters()
                .set("preview-fps-range", "30000,30000");
            ((ParametersHandler) cameraUiWrapper.getParameterHandler()).SetParametersToCamera(((ParametersHandler) cameraUiWrapper
                .getParameterHandler()).getParameters());
        }
