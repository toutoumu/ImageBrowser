...
public class BurstManualParam extends BaseManualParameter {
    ...
    public void setValue(int valueToSet, boolean setToCamera) {
        ...
        if (parameters.get(FreedApplication.getStringFromRessources(R.string.num_snaps_per_shutter)) != null) {
            parameters.set(FreedApplication.getStringFromRessources(R.string.num_snaps_per_shutter),
                           String.valueOf((currentInt + 1)));
            parameters.set(FreedApplication.getStringFromRessources(R.string.snapshot_burst_num),
                           String.valueOf((currentInt + 1)));
            Log.d(TAG,
                  FreedApplication.getStringFromRessources(R.string.num_snaps_per_shutter) + String.valueOf(currentInt + 1));
    ...
    public void onModuleChanged(ModuleHasChangedEvent event) {
        ...
        if ((module.equals(FreedApplication.getStringFromRessources(R.string.module_video)) || module.equals(FreedApplication
                                                                                                                 .getStringFromRessources(
                                                                                                                     R.string.module_hdr)))
