...
public class MotoHDR extends BaseModeParameter {
    ...
    public void SetValue(String valueToSet, boolean setToCam) {
        ...
        if (valueToSet.equals(FreedApplication.getStringFromRessources(R.string.on_))) {
            parameters.set(FreedApplication.getStringFromRessources(R.string.scene_mode),
                           FreedApplication.getStringFromRessources(R.string.scene_mode_hdr));
        } else if (valueToSet.equals(FreedApplication.getStringFromRessources(R.string.off_))) {
            parameters.set(FreedApplication.getStringFromRessources(R.string.scene_mode),
                           FreedApplication.getStringFromRessources(R.string.auto_));
        } else if (valueToSet.equals(FreedApplication.getStringFromRessources(R.string.auto_))) {
            parameters.set(FreedApplication.getStringFromRessources(R.string.scene_mode),
                           FreedApplication.getStringFromRessources(R.string.auto_hdr));
        }
    ...
    public String GetStringValue() {
        ...
        if (parameters.get(FreedApplication.getStringFromRessources(R.string.scene_mode))
            .equals(FreedApplication.getStringFromRessources(R.string.auto_))) {
            return FreedApplication.getStringFromRessources(R.string.off_);
        } else if (parameters.get(FreedApplication.getStringFromRessources(R.string.scene_mode))
        ...
        } else { return FreedApplication.getStringFromRessources(R.string.auto_); }
    }
