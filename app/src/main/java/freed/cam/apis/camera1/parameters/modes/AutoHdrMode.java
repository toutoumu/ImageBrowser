...
public class AutoHdrMode extends BaseModeParameter {
    ...
    public AutoHdrMode(Camera.Parameters parameters, CameraWrapperInterface cameraUiWrapper, SettingKeys.Key settingMode) {
        ...
        if (autohdr != null
            ...
            && autohdr.equals(FreedApplication.getStringFromRessources(R.string.true_))
            && parameters.get(FreedApplication.getStringFromRessources(R.string.auto_hdr_enable)) != null) {

            List<String> Scenes =
                new ArrayList<>(Arrays.asList(parameters.get(FreedApplication.getStringFromRessources(R.string.scene_mode_values))
                                                  .split(",")));
    ...
    public void setValue(String valueToSet, boolean setToCam) {
        if (valueToSet.equals(FreedApplication.getStringFromRessources(R.string.on_))) {
            parameters.set(FreedApplication.getStringFromRessources(R.string.scene_mode),
                           FreedApplication.getStringFromRessources(R.string.auto));
            parameters.set(FreedApplication.getStringFromRessources(R.string.auto_hdr_enable),
                           FreedApplication.getStringFromRessources(R.string.disable_));
            ...
            parameters.set(FreedApplication.getStringFromRessources(R.string.scene_mode),
                           FreedApplication.getStringFromRessources(R.string.scene_mode_asd));
            parameters.set(FreedApplication.getStringFromRessources(R.string.auto_hdr_enable),
                           FreedApplication.getStringFromRessources(R.string.enable_));
        }
        Log.d(TAG, "set auto hdr");
        if (setToCam) { ((ParametersHandler) cameraUiWrapper.getParameterHandler()).SetParametersToCamera(parameters); }
    ...
    public String GetStringValue() {
        if (parameters.get(FreedApplication.getStringFromRessources(R.string.auto_hdr_enable)) != null) {
            if (parameters.get(FreedApplication.getStringFromRessources(R.string.auto_hdr_enable))
                .equals(FreedApplication.getStringFromRessources(R.string.enable_))
                && parameters.get(FreedApplication.getStringFromRessources(R.string.scene_mode))
                .equals(FreedApplication.getStringFromRessources(R.string.scene_mode_hdr))) {
                return FreedApplication.getStringFromRessources(R.string.on_);
            } else if (parameters.get(FreedApplication.getStringFromRessources(R.string.auto_hdr_enable))
                .equals(FreedApplication.getStringFromRessources(R.string.enable_))
                && parameters.get(FreedApplication.getStringFromRessources(R.string.scene_mode))
                .equals(FreedApplication.getStringFromRessources(R.string.scene_mode_asd))) {
    ...
    public void onModuleChanged(String module) {
        curmodule = module;
        if (curmodule.equals(FreedApplication.getStringFromRessources(R.string.module_video)) || curmodule.equals(
            FreedApplication.getStringFromRessources(R.string.module_video))) {
            hide();
    ...
    public void onPictureFormatChanged(ValueChangedEvent<String> valueChangedEvent) {
        if (valueChangedEvent.key == SettingKeys.PictureFormat) {
            ...
            if (format.contains(FreedApplication.getStringFromRessources(R.string.jpeg_)) && !visible && !curmodule.equals(
                FreedApplication.getStringFromRessources(R.string.module_hdr))) { show(); } else if (!format.contains(
                FreedApplication.getStringFromRessources(R.string.jpeg_)) && visible) {
                hide();
            }
        }
    }
