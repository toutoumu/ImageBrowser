...
public class VideoStabilizationParameter extends BaseModeParameter {
    private final String[] vs_values = {
        FreedApplication.getStringFromRessources(R.string.true_), FreedApplication.getStringFromRessources(R.string.false_)
    };
    ...
    public VideoStabilizationParameter(Parameters parameters, CameraWrapperInterface parameterChanged) {
        ...
        if (parameters.get(FreedApplication.getStringFromRessources(R.string.video_stabilization_supported)) != null
            && parameters.get(FreedApplication.getStringFromRessources(R.string.video_stabilization_supported))
    ...
    public String GetStringValue() {
        ...
        if (vs != null && !TextUtils.isEmpty(vs)) { return vs; } else { return "error"; }
    }
}