...
public class ExposureManualParameter extends BaseManualParameter {
    ...
    public ExposureManualParameter(Parameters parameters,
                                   CameraWrapperInterface cameraUiWrapper,
                                   SettingKeys.Key settingMode) {
        super(parameters, cameraUiWrapper, settingMode);
        stringvalues = createStringArray(parameters.getMinExposureCompensation(),
    ...
    public void setValue(int valueToset, boolean setToCamera) {
        if (stringvalues == null || stringvalues.length == 0) { return; }
