...
public class JpegQualityModeApi2 extends BaseModeApi2 {
    ...
    public String GetStringValue() {
        if (TextUtils.isEmpty(SettingsManager.get(SettingKeys.JpegQuality).get())) { return "100"; } else {
    ...
    public void setValue(String valueToSet, boolean setToCamera) {
        ...
        cameraUiWrapper.captureSessionHandler.SetParameterRepeating(CaptureRequest.JPEG_QUALITY,
                                                                    (byte) Integer.parseInt(valueToSet),
                                                                    setToCamera);
