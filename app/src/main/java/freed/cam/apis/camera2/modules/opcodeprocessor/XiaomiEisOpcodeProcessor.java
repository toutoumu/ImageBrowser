...
public class XiaomiEisOpcodeProcessor extends BaseOpcodeProcessor {
    ...
    public void applyOpCodeToSession() {
        ...
        captureSessionHandler.SetPreviewParameter(CaptureRequest.CONTROL_VIDEO_STABILIZATION_MODE,
                                                  CaptureRequest.CONTROL_VIDEO_STABILIZATION_MODE_ON,
                                                  false);
        captureSessionHandler.SetPreviewParameter(CaptureRequest.LENS_OPTICAL_STABILIZATION_MODE,
    ...
    public void prepareRecording() {
        if (SettingsManager.get(SettingKeys.XIAOMI_VIDEO_RECORD_CONTROL).isSupported()) {
            captureSessionHandler.SetPreviewParameter(CaptureRequestXiaomi.VIDEO_RECORD_CONTROL,
                                                      CaptureRequestXiaomi.VALUE_VIDEO_RECORD_CONTROL_PREPARE,
                                                      false);
        }
    }
    ...
    public void startRecording() {
        ...
        if (SettingsManager.get(SettingKeys.XIAOMI_VIDEO_RECORD_CONTROL).isSupported()) {
            captureSessionHandler.SetPreviewParameter(CaptureRequestXiaomi.VIDEO_RECORD_CONTROL,
                                                      CaptureRequestXiaomi.VALUE_VIDEO_RECORD_CONTROL_START,
                                                      false);
        }
    }
    ...
    public void stopRecording() {
        ...
        if (SettingsManager.get(SettingKeys.XIAOMI_VIDEO_RECORD_CONTROL).isSupported()) {
            captureSessionHandler.SetPreviewParameter(CaptureRequestXiaomi.VIDEO_RECORD_CONTROL,
                                                      CaptureRequestXiaomi.VALUE_VIDEO_RECORD_CONTROL_STOP,
                                                      true);
        }
        try {
            Thread.sleep(300);
