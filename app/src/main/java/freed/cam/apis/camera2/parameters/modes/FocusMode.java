...
public class FocusMode extends BaseModeApi2 {
    ...
    public void setValue(String valueToSet, boolean setToCamera) {
        ...
        if (parameterValues == null || parameterValues.get(valueToSet) == null) { return; }
        ...
        switch (toset) {
            ...
            case CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_VIDEO:
                if (!SettingsManager.getInstance().getIsFrontCamera()) {
                    ...
                    if (captureSessionHandler.getPreviewParameter(CaptureRequest.CONTROL_AF_TRIGGER)
                        != CaptureRequest.CONTROL_AF_TRIGGER_IDLE) {
                        captureSessionHandler.SetParameter(CaptureRequest.CONTROL_AF_TRIGGER,
