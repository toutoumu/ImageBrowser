...
public class AeTargetRangeApi2 extends BaseModeApi2 {
    ...
    public AeTargetRangeApi2(Camera2 cameraUiWrapper,
                             SettingKeys.Key settingMode,
                             CaptureRequest.Key<Range<Integer>> parameterKey) {
    ...
    public void setValue(String valueToSet, boolean setToCamera) {
        ...
        if (setToCamera) { CameraThreadHandler.restartPreviewAsync(); }
        //captureSessionHandler.SetParameterRepeating(key, t,setToCamera);
        if (settingMode != null) { settingMode.set(valueToSet); }
    }
