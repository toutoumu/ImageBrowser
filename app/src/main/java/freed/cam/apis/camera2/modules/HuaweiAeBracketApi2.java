...
public class HuaweiAeBracketApi2 extends AeBracketApi2 {
    ...
    protected void prepareCaptureBuilder(int captureNum) {
       ...
       /* Rational exporat;
        ...
        cameraUiWrapper.captureSessionHandler.SetCaptureParameter(CaptureRequestHuawei.HUAWEI_PROFESSIONAL_MODE,
        ...
        cameraUiWrapper.captureSessionHandler.SetPreviewParameter(CaptureRequestHuawei.HUAWEI_PROFESSIONAL_MODE,
                                                                  CaptureRequestHuawei.HUAWEI_PROFESSIONAL_MODE_ENABLED,
                                                                  true);
        cameraUiWrapper.captureSessionHandler.SetPreviewParameter(CaptureRequestHuawei.HUAWEI_SENSOR_EXPOSURE_TIME,
                                                                  msexpo,
                                                                  true);
        //cameraUiWrapper.captureSessionHandler.SetPreviewParameter(CaptureRequestEx.HUAWEI_PROF_EXPOSURE_TIME, exporat);
        cameraUiWrapper.captureSessionHandler.SetPreviewParameter(CaptureRequestHuawei.HUAWEI_SENSOR_ISO_VALUE,
                                                                  currentiso,
                                                                  true);
