...
public class ManualWbCtApi2Hw extends AbstractParameter<Camera2> {
    ...
    public void setValue(int valueToSet, boolean setToCamera) {
        ...
        { toset = 0; } else { toset = Integer.parseInt(stringvalues[currentInt]); }
        cameraUiWrapper.captureSessionHandler.SetParameterRepeating(CaptureRequestHuawei.HUAWEI_SENSOR_WB_VALUE,
                                                                    toset,
                                                                    setToCamera);
    }
}
