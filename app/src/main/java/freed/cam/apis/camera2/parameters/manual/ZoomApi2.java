...
public class ZoomApi2 extends AbstractParameter<Camera2> {
    ...
    public ZoomApi2(Camera2 cameraUiWrapper) {
        ...
        maxzoom =
            ((CameraHolderApi2) cameraUiWrapper.getCameraHolder()).characteristics.get(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM);
        sensorSize =
    ...
    public ViewState getViewState() {
        if (((CameraHolderApi2) cameraUiWrapper.getCameraHolder()).characteristics.get(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM)
            > 0) { return ViewState.Visible; } else { return ViewState.Hidden; }
    }
