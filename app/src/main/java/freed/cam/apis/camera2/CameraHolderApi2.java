...
public class CameraHolderApi2 extends CameraHolderAbstract {
    ...
    private void printCharacteristics() {
        ...
        Log.d(TAG,
              "ExposureTImeMax:" + characteristics.get(CameraCharacteristics.SENSOR_INFO_EXPOSURE_TIME_RANGE).getUpper());
        Log.d(TAG,
              "ExposureTImeMin:" + characteristics.get(CameraCharacteristics.SENSOR_INFO_EXPOSURE_TIME_RANGE).getLower());
