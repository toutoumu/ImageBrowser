...
public abstract class AeManager implements AeManagerInterface {
    ...
    public boolean isExposureCompensationWriteable() {
        return activeAeState == AeStates.iso_priority
            || activeAeState == AeStates.shutter_priority
    ...
    public class ManualExposureTime extends AbstractParameter {
        ...
        public String GetStringValue() {
            if (stringvalues == null || stringvalues.length == 0 || currentInt > stringvalues.length) { return "error"; }
        ...
        public ViewState getViewState() {
            if (isExposureTimeWriteable()) { return ViewState.Enabled; } else { return ViewState.Disabled; }
        }
    ...
    public class ManualIso extends AbstractParameter {
        ...
        @Override
        public ViewState getViewState() {
            if (isIsoWriteable()) { return ViewState.Enabled; } else { return ViewState.Disabled; }
        }
    ...
    public class ExposureCompensation extends AbstractParameter {
        ...
        @Override
        public ViewState getViewState() {
            if (isExposureCompensationWriteable()) { return ViewState.Enabled; } else { return ViewState.Disabled; }
        }
    }
}
