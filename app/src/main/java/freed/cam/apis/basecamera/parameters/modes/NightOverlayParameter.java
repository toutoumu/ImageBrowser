...
public class NightOverlayParameter extends AbstractParameter {
    ...
    public String GetStringValue() {
        ...
        if (enable) { return FreedApplication.getStringFromRessources(R.string.on_); } else {
    ...
    public void SetValue(String valueToSet, boolean setToCamera) {
        SettingsManager.getGlobal(SettingKeys.NightOverlay)
            .set(valueToSet.equals(FreedApplication.getStringFromRessources(R.string.on_)));
