...
public class CameraThreadHandler extends Handler {
    ...
    public static void createCameraAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.createCamera(); }
    }

    public static void initCameraAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.initCamera(); }
    }

    public static void startCameraAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.startCamera(); }
    }
    ...
    public static void stopCameraAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.stopCamera(); }
    }

    public static void restartCameraAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.restartCamera(); }
    }

    public static void startPreviewAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.startPreview(); }
    }

    public static void stopPreviewAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.stopPreview(); }
    }

    public static void restartPreviewAsync() {
        if (cameraThreadHandler != null) { cameraThreadHandler.restartPreview(); }
    }
