...
public class SwipeMenuListner extends TouchHandler {
    ...
    protected void doLeftToRightSwipe() {
        if (swipehandler != null) { swipehandler.doLeftToRightSwipe(); }
    }

    protected void doRightToLeftSwipe() {
        if (swipehandler != null) { swipehandler.doRightToLeftSwipe(); }
    }

    protected void doTopToBottomSwipe() {
        if (swipehandler != null) { swipehandler.doTopToBottomSwipe(); }
    }

    protected void doBottomToTopSwipe() {
        if (swipehandler != null) { swipehandler.doBottomToTopSwipe(); }
    }
    ...
    protected void OnMotionEvent(MotionEvent event) {
        if (swipehandler != null) { swipehandler.onMotionEvent(event); }
    }
