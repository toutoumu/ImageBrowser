 ...
 */
public class ManualFragment extends AbstractFragment
    implements OnSeekBarChangeListener, ParameterEvents, ModuleChangedEvent, CurveView.CurveChangedEvent {
    ...
    public void setCameraToUi(CameraWrapperInterface wrapper) {
        ...
        if (manualItemsHolder == null) { return; }
        ...
        if (cameraUiWrapper != null) {
            ...
            if (parms.get(SettingKeys.M_ManualIso) != null) {
                ManualButton btn =
                    new ManualButtonIso(getContext(), parms.get(SettingKeys.M_ManualIso), R.drawable.manual_iso);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            if (parms.get(SettingKeys.M_ExposureTime) != null) {
                ManualButton btn =
                    new ManualButtonShutter(getContext(), parms.get(SettingKeys.M_ExposureTime), R.drawable.manual_shutter);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            ...
            if (parms.get(SettingKeys.M_ExposureCompensation) != null) {
                ManualButton btn = new ManualButton(getContext(),
                                                    parms.get(SettingKeys.M_ExposureCompensation),
                                                    R.drawable.manual_exposure);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            if (parms.get(SettingKeys.M_Whitebalance) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_Whitebalance), R.drawable.manual_wb);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            ...
            if (parms.get(SettingKeys.M_Contrast) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_Contrast), R.drawable.manual_contrast);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            if (parms.get(SettingKeys.M_Brightness) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_Brightness), R.drawable.brightness);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            if (parms.get(SettingKeys.M_Saturation) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_Saturation), R.drawable.manual_saturation);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            if (parms.get(SettingKeys.M_Sharpness) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_Sharpness), R.drawable.manual_sharpness);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            ...
            if (parms.get(SettingKeys.M_ProgramShift) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_ProgramShift), R.drawable.manual_shift);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            if (parms.get(SettingKeys.SCALE_PREVIEW) != null) {
                ManualButton btn =
                    new ManualButton(getContext(), parms.get(SettingKeys.M_PreviewZoom), R.drawable.manual_zoom);
                btn.setOnClickListener(manualButtonClickListner);
                manualItemsHolder.addView(btn);
            }
            /*if (parms.black != null) {
            ...
            if (parms.get(SettingKeys.TONE_CURVE_PARAMETER) != null) {
                ManualButtonToneCurve btn = new ManualButtonToneCurve(getContext(),
                                                                      parms.get(SettingKeys.TONE_CURVE_PARAMETER),
                                                                      R.drawable.manual_midtones);
                btn.setOnClickListener(manualButtonClickListner);
            ...
            if (cameraUiWrapper.getModuleHandler()
                .getCurrentModuleName()
                .equals(FreedApplication.getStringFromRessources(R.string.module_afbracket))
                && currentButton instanceof ManualButtonMF
                && seekbar.getVisibility() == View.VISIBLE) { afBracketSettingsView.setVisibility(View.VISIBLE); } else {
                afBracketSettingsView.setVisibility(View.GONE);
            }
        }
    }
    ...
    private final OnClickListener manualButtonClickListner = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //if no button was active or a different was clicked
                ...
                if (seekbar.getVisibility() == View.GONE) { seekbar.setVisibility(View.VISIBLE); }
                ...
                if (currentButton instanceof ManualButtonMF && cameraUiWrapper.getModuleHandler()
                    .getCurrentModuleName()
                    .equals(FreedApplication.getStringFromRessources(R.string.module_afbracket))) {
                    afBracketSettingsView.setVisibility(View.VISIBLE);
                } else { afBracketSettingsView.setVisibility(View.GONE); }
    ...
    public void onModuleChanged(String module) {
        if (cameraUiWrapper == null || FreedApplication.getContext() == null) { return; }
        if (module.equals(FreedApplication.getStringFromRessources(R.string.module_afbracket))
            && seekbar.getVisibility() == View.VISIBLE) { afBracketSettingsView.setVisibility(View.VISIBLE); } else {
            afBracketSettingsView.setVisibility(View.GONE);
        }
    }
    ...
    public void onCurveChanged(PointF[] pointFs) {
        ...
        ((ManualToneMapCurveApi2.ToneCurveParameter) cameraUiWrapper.getParameterHandler()
            .get(SettingKeys.TONE_CURVE_PARAMETER)).setCurveToCamera(ar);
    }
    ...
    public void onCurveChanged(PointF[] r, PointF[] g, PointF[] b) {
        ((ManualToneMapCurveApi2.ToneCurveParameter) cameraUiWrapper.getParameterHandler()
            .get(SettingKeys.TONE_CURVE_PARAMETER)).setCurveToCamera(pointFtoFloatArray(r),
                                                                     pointFtoFloatArray(g),
                                                                     pointFtoFloatArray(b));
    }
