...
public class CompassDrawer extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(width / 2 + TEXTSHADOWMARGINE,
                        0 + TEXTSHADOWMARGINE,
                        width / 2 + TEXTSHADOWMARGINE,
                        20 + TEXTSHADOWMARGINE,
                        paint);
        paint.setColor(Color.WHITE);
        ...
        for (int i = 0; i < directionValue.length; i++) {
            ...
            if (postodraw + width / 2 > allitemsWidth + itemwidth) { postodraw -= allitemsWidth; }
            paint.setColor(Color.BLACK);
            ...
            paint.setColor(Color.BLACK);
            canvas.drawLine(getItemCenterMargine(postodraw),
                            21 + TEXTSHADOWMARGINE,
                            getItemCenterMargine(postodraw),
                            41 + TEXTSHADOWMARGINE,
                            paint);
            paint.setColor(Color.WHITE);
