...
public class ImageViewTouchAreaHandler implements OnTouchListener {
     ...
     */
    public ImageViewTouchAreaHandler(ImageView imageView,
     ...
     */
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (allowDrag) {
                    if (event.getX() - difx > cameraUiWrapper.getMargineLeft()
                        && event.getX() - difx + imageView.getWidth()
                        < cameraUiWrapper.getMargineLeft() + cameraUiWrapper.getPreviewWidth()) {
                        imageView.setX(event.getX() - difx);
                    }
                    if (event.getY() - dify > cameraUiWrapper.getMargineTop()
                        && event.getY() - dify + imageView.getHeight()
                        < cameraUiWrapper.getMargineTop() + cameraUiWrapper.getPreviewHeight()) {
     ...
     */
                    ...
                    if ((xd >= distance || yd >= distance) && !moving) {
                        ...
                        ret = false;
                        if (touchListnerEvent != null) { touchListnerEvent.IsMoving(true); }
                    }
                }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (x < cameraUiWrapper.getMargineLeft() || x > cameraUiWrapper.getMargineRight()
                    || y < cameraUiWrapper.getMargineTop()) { return true; }
...
*/
                    if (touchListnerEvent != null) {
                        touchListnerEvent.onAreaCHanged((int) x,
                                                        (int) y,
                                                        cameraUiWrapper.getPreviewWidth(),
                                                        cameraUiWrapper.getPreviewHeight());
