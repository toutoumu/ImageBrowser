...
public class UiSettingsChildCameraSwitch extends UiSettingsChild {
    ...
    private void switchCamera() {
        ...
        if (currentCamera++ >= maxcams - 1) { currentCamera = 0; }
    ...
    private String getCamera(int i) {
        if (SettingsManager.getInstance().getIsFrontCamera()) { return "Front " + i; } else { return "Back " + i; }
    }
    ...
    public String[] GetValues() {
        ...
        for (int i = 0; i < camids.length; i++) {
            if (SettingsManager.getInstance().getCamIsFrontCamera(i)) { retarr[i] = "Front " + i; } else {
                retarr[i] = "Back " + i;
            }
        }
        return retarr;
