...
public class SettingsChildMenuForceRawToDng extends SettingsChildMenu {
    ...
    public SettingsChildMenuForceRawToDng(Context context, int headerid, int descriptionid) {
        ...
        } else { SetValue(getContext().getResources().getString(R.string.off)); }
    }

    @Override
    public String[] GetValues() {
        return new String[] {
            getContext().getResources().getString(R.string.off), getContext().getResources().getString(R.string.on)
        };
    }
    ...
    public void SetValue(String value) {
        ...
        } else { SettingsManager.get(SettingKeys.forceRawToDng).set(true); }
