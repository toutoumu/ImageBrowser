...
public class ManualButtonShutter extends ManualButton {
    ...
    public void onShutterSpeedChanged(ShutterSpeedChangedEvent shutterSpeedChangedEvent) {
        if (shutterSpeedChangedEvent.type != String.class) { return; }
        if (shutterSpeedChangedEvent.key == parameter.getKey()) { valueTextView.setText(shutterSpeedChangedEvent.newValue); }
    }
}
