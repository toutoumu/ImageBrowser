...
public class UiSettingsChild extends SettingsChildAbstract {
    ...
    public void onStringValueChanged(ValueChangedEvent<String> value) {
        if (value.type != String.class || parameter == null) { return; }
        if (value.key == parameter.getKey()) { onStringValueChanged(value.newValue); }
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (parameter != null) { parameter.fireStringValueChanged(parameter.GetStringValue()); }
    }
    ...
    protected void setTextToTextBox(ParameterInterface parameter) {
        if (parameter != null && parameter.GetStringValue() != null) {
            ...
            if (campara != null && !TextUtils.isEmpty(campara)) { onStringValueChanged(campara); }
        }
    }
    ...
    public void onClick(View v) {
        if (onItemClick != null) { onItemClick.onSettingsChildClick(this, fromleft); }
    }
}
