...
public class GuideHandler extends Fragment implements ParameterEvents {
    ...
    public void onResume() {
        ...
        if (cameraUiWrapper != null
            ...
            && cameraUiWrapper.getParameterHandler().get(SettingKeys.PreviewSize) != null) {
            previewSizeChanged.onStringValueChanged(cameraUiWrapper.getParameterHandler()
    ...
    public void setCameraUiWrapper(CameraWrapperInterface cameraUiWrapper) {
        ...
        if (img != null) { SetViewG(SettingsManager.getGlobal(SettingKeys.GuideList).get()); }
    }
