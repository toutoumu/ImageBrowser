...
public class MediaCodecInfoParser {
    ...
    public static String getProfileString(String type, int profile) {
        if (type.equals(hevc)) { return getHevcProfileString(profile); } else if (type.equals(avc)) {
    ...
    public static String getLevelString(String type, int profile) {
        if (type.equals(hevc)) { return getHevcLevelString(profile); } else if (type.equals(avc)) {
                        ...
                        if (s.equals(hevc)) {
                            Log.d(TAG,
                                  "Type: "
                                      + s
                                      + " profile: "
                                      + getHevcProfileString(lvl.profile)
                                      + " lvl: "
                                      + getHevcLevelString(lvl.level));
                        }
                        if (s.equals(avc)) {
                            Log.d(TAG,
                                  "Type: "
                                      + s
                                      + " profile: "
                                      + getAvcProfileString(lvl.profile)
                                      + " lvl: "
                                      + getAvcLevelString(lvl.level));
                        }
                    }
                }
            }
