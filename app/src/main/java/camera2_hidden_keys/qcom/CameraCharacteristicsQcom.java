...
public class CameraCharacteristicsQcom extends AbstractCameraCharacteristics {
    ...
    static {
        ...
        availableStreamConfigurationsQuadra =
            getKeyType("org.codeaurora.qcamera3.quadra_cfa.availableStreamConfigurations", int[].class);
        ...
        qcfa_availableStreamConfigurations =
            getKeyType("org.codeaurora.qcamera3.quadra_cfa.availableStreamConfigurations", Integer[].class);
        ...
        support_video_hdr_modes =
            getKeyType("org.codeaurora.qcamera3.available_video_hdr_modes.video_hdr_modes", int[].class);
    }
}
