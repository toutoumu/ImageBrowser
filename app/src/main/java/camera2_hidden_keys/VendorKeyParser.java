...
public class VendorKeyParser {
    ...
    public void readVendorKeys(CameraCharacteristics cameraCharacteristics)
    ...
    private ArrayList getAllvendorKeysApi29(CameraCharacteristics characteristics)
        throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        Method getAllVendorKeys =
            RestrictionBypass.getDeclaredMethod(mProperties.getClass(), "getAllVendorKeys", Class.class);
    ...
    private ArrayList getAllvendorKeysApi26(CameraCharacteristics characteristics)
        throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
