...
public class CameraCharacteristicsSamsung extends AbstractCameraCharacteristics {
    ...
    static {
        LOGICAL_MULTI_CAMERA_MASTER_PHYSICAL_ID =
            getKeyType("samsung.android.logicalMultiCamera.masterPhysicalId", String.class);
        LOGICAL_MULTI_CAMERA_DUAL_CALIBRATION =
            getKeyType("samsung.android.logicalMultiCamera.dualCalibration", byte[].class);
    }
}
