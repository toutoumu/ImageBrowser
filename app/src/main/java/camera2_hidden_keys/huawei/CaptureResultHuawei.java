...
public class CaptureResultHuawei extends AbstractCaptureResult {
    ...
    static {
        ...
        HUAWEI_LIGHT_PAINTING_EXPOSURE_TIME =
            getKeyType("com.huawei.capture.metadata.lightPaintingExposureTime", Integer.TYPE);
        ...
        HUAWEI_EXPOSURE_MODE_PREVIEW_STATE =
            getKeyType("com.huawei.capture.metadata.hw-exposure-mode-preview-state", Byte.TYPE);
