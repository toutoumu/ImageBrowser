...
public class CameraCharacteristicsEx {
    ...
    static {
        ...
        HUAWEI_AVAILABLE_COLOR_EFFECT_MODES =
            getKeyClass("com.huawei.device.capabilities.availbaleEffectModes", byte[].class);
        HUAWEI_AVAILABLE_COLOR_EFFECT_RANGE =
            getKeyClass("com.huawei.device.capabilities.availbaleEffectRange", int[].class);
        ...
        HUAWEI_AVAILABLE_EXPOSURE_MODES =
            getKeyClass("com.huawei.device.capabilities.availbaleLightPaintingModes", byte[].class);
        ...
        HUAWEI_AVAILABLE_SUPERNIGHT_ISO_VALUE =
            getKeyClass("com.huawei.device.capabilities.availbaleSupernightIso", byte[].class);
        HUAWEI_AVAILABLE_SUPERNIGHT_EXPOSURE_VALUE =
            getKeyClass("com.huawei.device.capabilities.availbaleSupernightExposureTime", byte[].class);
        HUAWEI_EXPOSURE_COMPENSATION_SUPPORTED =
            getKeyType("com.huawei.device.capabilities.hwExposureCompensationSupported", Byte.TYPE);
        HUAWEI_EXPOSURE_COMPENSATION_STEP =
            getKeyType("com.huawei.device.capabilities.hwExposureCompensationStep", Float.TYPE);
        ...
        HUAWEI_AVAILABLE_FRONT_FLASH_LEVEL =
            getKeyClass("com.huawei.device.capabilities.availbaleFrontFlashLevel", int[].class);
        HUAWEI_PROFESSIONAL_MODE_SUPPORTED =
            getKeyType("com.huawei.device.capabilities.professionalModeSupported", Byte.TYPE);
        HUAWEI_SENSOR_WB_RANGE = getKeyClass("com.huawei.device.capabilities.sensorWbRange", int[].class);
        HUAWEI_SENSOR_EXPOSURETIME_RANGE =
            getKeyClass("com.huawei.device.capabilities.hw-sensor-exposure-range", int[].class);
        ...
        HUAWEI_FLASH_ASSIST_FOCUS_SUPPORTED =
            getKeyClass("com.huawei.device.capabilities.flashAssistFocusSupported", byte[].class);
        HUAWEI_MONO_MODE_SUPPORTED = getKeyType("com.huawei.device.capabilities.monoModeSupported", Byte.TYPE);
        HUAWEI_AVAILABLE_MONO_FILTER_MODES =
            getKeyClass("com.huawei.device.capabilities.availableMonoFilterModes", byte[].class);
        ...
        HUAWEI_FRONT_VIRTUAL_EFFECT_SUPPORTED_RANGE =
            getKeyClass("com.huawei.device.capabilities.frontVirtualEffectSupportedValue", byte[].class);
        HUAWEI_DUAL_PRIMARY_SINGLE_REPROCESS =
            getKeyType("com.huawei.device.capabilities.dualPrimarySingleReprocess", Byte.TYPE);
        HUAWEI_VDR_SUPPORTED = getKeyType("com.huawei.device.capabilities.vdrSupported", Byte.TYPE);
        HUAWEI_SUPER_RESOLUTION_PICTURE_SIZE =
            getKeyClass("com.huawei.device.capabilities.superResolutionPictureSize", int[].class);
        HUAWEI_SENCONDARY_SENSOR_PIXEL_ARRAY_SIZE =
            getKeyClass("com.huawei.device.capabilities.hwSubActiveArraySize", int[].class);
        HUAWEI_SENCONDARY_SENSOR_SUPPORTED_SIZE =
            getKeyClass("com.huawei.device.capabilities.hwSubSensorJpegSize", int[].class);
        HUAWEI_SENCONDARY_JPEG_SUPPORTED_SIZE =
            getKeyClass("com.huawei.device.capabilities.secondAvailableJpegSizes", int[].class);
        HUAWEI_SUPPORTED_BINNING_SIZES =
            getKeyClass("com.huawei.device.capabilities.hw-sensor-binning-sizes-supported", int[].class);
        HUAWEI_OPTICAL_ZOOM_THRESHOLD = getKeyType("com.huawei.device.capabilities.opticalZoomThreshold", Byte.TYPE);
        HUAWEI_VIDEO_CALLBACK_THRESHOLD =
            getKeyType("com.huawei.device.capabilities.highVideoCallbackThresholdSupported", Byte.TYPE);
        ...
        HUAWEI_QUICKTHUMBNAIL_SUPPORTED_SIZE =
            getKeyClass("com.huawei.device.capabilities.quickthumbnailResolutionSupported", int[].class);
        HUAWEI_FAST_NOTIFY_SUPPORTED = getKeyType("com.huawei.device.capabilities.fastBinderSupported", Byte.TYPE);
        HUAWEI_BIG_APERTURE_ZOOM_THRESHOLD =
            getKeyType("com.huawei.device.capabilities.bigApertureZoomThreshold", Byte.TYPE);
        HUAWEI_VIDEO_STABILIZATION_DEFAULT_ON =
            getKeyType("com.huawei.device.capabilities.hwVideoStabilizationDefaultOn", Byte.TYPE);
        ...
        HUAWEI_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS =
            getKeyClass("com.huawei.device.capabilities.hwAvailableDepthStreamConfigurations", int[].class);
        HUAWEI_OPTICAL_MAX_ZOOM_VALUE = getKeyType("com.huawei.device.capabilities.opticalMaxZoomValue", Byte.TYPE);
        HUAWEI_PROFESSIONAL_RAW12_SUPPORTED =
            getKeyClass("com.huawei.device.capabilities.hw-professional-raw12-supported", int[].class);
        ...
        HUAWEI_AVAILIBLE_PREVIEW_DEPTH_SIZES =
            getKeyClass("com.huawei.device.capabilities.availablePreviewDepthSizes", int[].class);
    }
