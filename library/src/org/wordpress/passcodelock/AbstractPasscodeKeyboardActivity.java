...
public abstract class AbstractPasscodeKeyboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //supportRequestWindowFeature(Window.FEATURE_NO_TITLE)//继承自AppCompatActivity用这句
        //去掉Activity上面的状态栏
        ...
        findViewById(R.id.button_none).setOnClickListener(defaultButtonListener);
    ...
    private OnClickListener defaultButtonListener = new OnClickListener() {
        ...
        @Override
        public void onClick(View arg0) {
            Object currentValue = "";// int currentValue = -1;
            int id = arg0.getId();
            if (id == R.id.button0) {
                currentValue = 0;
    ...
    protected void showPasswordError() {
        TipDialog.show(this, R.string.passcode_wrong_passcode, TipDialog.TYPE.ERROR);
