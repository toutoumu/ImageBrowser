...
public class PasscodeManagePasswordActivity extends AbstractPasscodeKeyboardActivity {
    ...
    public void onResume() {
        ...
        if (mFingerprintManager.isHardwareDetected()
            ...
            mFingerprintManager.authenticate(null, 0, mCancel = new CancellationSignal(),
                                             getFingerprintCallback(), null);
        ...
        switch (type) {
            ...
            case PasscodePreferenceFragment.ENABLE_PASSLOCK:
                if (unverifiedPasscode == null) {
                    ((TextView) findViewById(R.id.passcodelock_prompt)).setText(
                        R.string.passcode_re_enter_passcode);
